...
const target1023 = (step1023.tool_calls[0].args.TargetContent || '').replace(/\r\n/g, '\n').replace(/\r/g, '\n');
console.log(`Length of target1023: ${target1023.length}`);

const targetLines = target1023.split('\n');
...
if (breakIndex !== -1) {
  ...
  console.log(`Last successful matching prefix length: ${matchPrefix.length}`);
  ...
  console.log('The entire target content matched!');
}
